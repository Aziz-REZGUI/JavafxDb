...
public class Formation {
    private  int code_formation,nombre_jours,annee,mois,nombre_participants;
    ...
    public Formation(int nombre_jours, int annee, int mois, int nombre_participants, String intitule) {
        this.nombre_jours = nombre_jours;
        this.annee = annee;
        this.mois = mois;
        this.nombre_participants = nombre_participants;
    ...
    public Formation(int code_formation, int nombre_jours, int annee, int mois, int nombre_participants, String intitule) {
        this.code_formation = code_formation;
        this.nombre_jours = nombre_jours;
        this.annee = annee;
        this.mois = mois;
